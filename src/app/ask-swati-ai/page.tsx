...
export default function AskSwatiAIDashboard() {
  ...
  if (!user) {
    return (
      <DefaultLayout>
        <div className="flex items-center justify-center px-4" style={{ backgroundColor: COLORS.surface, minHeight: '100vh' }}>          <div className="rounded-2xl p-8 max-w-md w-full text-center" style={{ backgroundColor: COLORS.white , border: `1px solid ${COLORS.border}`, boxShadow: '0 4px 24px rgba(165, 28, 48, 0.08)' }}>
