...
import { Search, ChevronDown, Heart, BookOpen, DollarSign, MapPin, GraduationCap, Filter, X, ChevronLeft, ChevronRight, AlertCircle, Calendar, Globe, Award } from 'lucide-react';
...
const CourseFinder: React.FC = () => {
  ...
  useEffect(() => {
    applyFilters();
  }, [searchQuery, selectedCountry, selectedStudyLevel, selectedUniversity, selectedCampus, selectedIntake, selectedDuration, scholarshipOnly, courses]);
  ...
  // Get unique values for dropdowns based on selected filters
